...
public class InimigoTest {
    ...
    public void danoAbsorvidoPorEscudo(){
        Inimigo i = new Inimigo("Inimigo1", 50, 10, 50);
        i.receberDano(5);
    ...
    public void danoParcialComEscudo(){
        Inimigo i = new Inimigo("Inimigo2", 50, 10, 50);
        i.receberDano(15);
    ...
    public void danoSemEscudo(){
        Inimigo i = new Inimigo("Inimigo3", 50, 0, 50);
        i.receberDano(10);
    ...
    public void vidaNaoFicaNegativa(){
        Inimigo i = new Inimigo("Inimigo4", 50, 0, 50);
        i.receberDano(70);
    ...
    public void estaVivoComVida(){
        Inimigo i = new Inimigo("Inimigo5", 50, 0, 50);
        assertEquals(true, i.estaVivo());
    }

    @Test
    public void estaVivoSemVida(){
        Inimigo i = new Inimigo("Inimigo6", 0, 0, 0);
        assertEquals(false, i.estaVivo());
    }

    @Test 
    public void ganhaEscudo(){
        Inimigo i = new Inimigo("Inimigo7", 50, 0, 50);
        i.ganharEscudo(10);
        assertEquals(50, i.qtdVida());
